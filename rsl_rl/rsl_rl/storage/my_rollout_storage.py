...
class My_RolloutStorage:
    ...
    def __init__(
        ...
        self.latent_feature = torch.zeros(num_transitions_per_env, num_envs, *feature_shape, device=self.device)
        self.real_forces = torch.zeros(num_transitions_per_env, num_envs, num_forces*3, device=self.device)
        # for distillation
    ...
    def add_transitions(self, transition: Transition):
        ...
        self.latent_feature[self.step].copy_(transition.latent_feature)
        self.real_forces[self.step].copy_(transition.real_forces)
        # for distillation
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        latent_feature = self.latent_feature.flatten(0, 1)
        real_forces = self.real_forces.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                latent_feature_batch = latent_feature[batch_idx]
                real_forces_batch = real_forces[batch_idx]
                ...
                latent_feature_batch, real_forces_batch
    ...
    def recurrent_mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        padded_latent_feature_trajectories, _ = split_and_pad_trajectories(self.latent_feature, self.dones)
        padded_real_forces_trajectories, _ = split_and_pad_trajectories(self.real_forces, self.dones)
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                latent_feature_batch = padded_latent_feature_trajectories[:, first_traj:last_traj]
                real_forces_batch = padded_real_forces_trajectories[:, first_traj:last_traj]
